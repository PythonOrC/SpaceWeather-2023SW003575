...
%%%%%%% LINEAR !!!!!
pc5i = griddata(long,lat,pc5, longi,lati);
...
caxis([-2.5 2.5])
str_title2=['pc5 BOU9 LINEARMaps 1.0 2008068 second-',num2str(i)];
title(str_title2);
annotation('textbox',...
...
str_title2s=['pc5_BOU9_LINEARMaps_1_2008068_second_',num2str(i)];
