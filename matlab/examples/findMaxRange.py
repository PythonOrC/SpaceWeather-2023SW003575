...
if PERIOD == "0509":
    if PRENOON == True:
        MANUAL = ["MAW"]
        f = open('D:\Github Repository\SpaceWeather\matlab\examples\HalloweenStorm-SuperMAG-0509_stations.csv', 'r')
    else:
        MANUAL=["MGD", "DRV","TWN","CTA", "HOB","LEM","TIK"]
        f = open('D:\Github Repository\SpaceWeather\matlab\examples\HalloweenStorm-SuperMAG-0509_stations_afternoon.csv', 'r')
else:
    if PRENOON == True:
        MANUAL = []
        f = open('D:\Github Repository\SpaceWeather\matlab\examples\HalloweenStorm-SuperMAG-1724_stations.csv', 'r')
    else:
        MANUAL=[]
        f = open('D:\Github Repository\SpaceWeather\matlab\examples\HalloweenStorm-SuperMAG-1724_stations_afternoon.csv', 'r')
